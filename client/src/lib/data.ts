...
export const methodSteps = [
  {
    step: 1,
    title: "Harvest",
    description: "We harvest only at peak potency, respecting the seasons and the soil.",
    note: "Sourced from 12,000ft altitude."
  },
  {
    step: 2,
    title: "Cleanse",
    description: "Raw botanicals are washed in glacial meltwater to remove impurities.",
    note: "Purest water source."
  },
  {
    step: 3,
    title: "Formulate",
    description: "Master Vaidyas blend herbs according to ancient texts.",
    note: "Siddha & Ayurveda lineage."
  },
  {
    step: 4,
    title: "Verify",
    description: "Modern labs test for heavy metals and potency.",
    note: "Triple-tested safety."
  },
  {
    step: 5,
    title: "Pack",
    description: "Sealed in amber glass to protect from UV light and preserve life force.",
    note: "Plastic-free packaging."
  }
];
